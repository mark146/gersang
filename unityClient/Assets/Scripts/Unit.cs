        ...
        void OnHitEvent() {
            if (_lockTarget != null) {
                ...
                if (_stat.Job.Equals("검투사") == true || _stat.Job.Equals("플레이어") == true) {
                    ...
                    //체력 깎는 텍스트 표시 - 참고: https://lesslate.github.io/unity/%EC%9C%A0%EB%8B%88%ED%8B%B0-%ED%94%8C%EB%A1%9C%ED%8C%85-%EB%8D%B0%EB%AF%B8%EC%A7%80-%ED%85%8D%EC%8A%A4%ED%8A%B8/
