    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        ...
        try {
            ...
            switch (message.ProtocolId()) {
                ...
                */
                case 8: case 4: case 6: case 5: case 9: case 14: case 15: case 16: case 17: case 18: case 19: case 20: case 22:
            ...
            switch (protocolId) {
                ...
                case 20: // 20: 클라이언트가 채팅메시지를 보낼 경우 호출
                    ...
                    break;
                case 22: // 22: 클라이언트 캐릭터 정보를 수정할 경우 호출
                    sendList.put("24", "ArrayIndexOutOfBoundsException 발생");
                    break;
                default:
