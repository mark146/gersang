...
public class EchoServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 참고: https://groups.google.com/forum/#!topic/netty-ko/-liUw3162kI
        ...
        // https://sina-bro.tistory.com/15?category=702782
        try {
            ...
            b.group(bossGroup, workerGroup)// 스레드 그룹 초기화
                    ...
                    .childHandler(new ChannelInitializer<SocketChannel>() {
                        ...
                        public void initChannel(SocketChannel ch) throws Exception {
                            ...
                            // 채널 파이프라인 객체를 생성한다.
                            // 채널 파이프라인에 controller.EchoServerHandler 클래스를 동록하여 클라이언트와 연결이 되었을 때 데이터 처리를 담당한다.
                            // initChannel은 클라이언트 소켓 채널이 생성될 때 호출됨
