...
//                System.out.println("invenInfo.size(): "+invenInfo.size());
//                System.out.println("gear.size(): "+gear.size());

                Map<String, List<String>> sendList = new HashMap();
                sendList.put("6", invenInfo);
                sendList.put("7", gear);

//                System.out.println("sendList.toString(): "+sendList.toString());
...
//                    System.out.println(", Value: "+ entry.getValue());
            ...
            case 16: // 플레이어가 아이템을 구매할 경우 실행, 데이터 수정해야할 정보: 플레이어 인벤토리, 돈
                ...
                for (int i = 0; i < tradeList.size(); i++){
                    System.out.println("sellList.get(i): "+tradeList.get(i));
                }
                */
                    // 인벤토리 슬롯 정보 수정
